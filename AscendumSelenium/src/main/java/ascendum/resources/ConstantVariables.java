...
//	public static final String generatedEmail = BaseActions.createRandomEmail();
//	public static final int generatedPhoneNo = BaseActions.createRandomePhoneNo();
